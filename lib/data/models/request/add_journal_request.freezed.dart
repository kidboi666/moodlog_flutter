...
mixin _$AddJournalRequest {
 ...
 String? get content; String get moodName; String? get imageUri; bool get aiResponseEnabled;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AddJournalRequest&&(identical(other.content, content) || other.content == content)&&(identical(other.moodName, moodName) || other.moodName == moodName)&&(identical(other.imageUri, imageUri) || other.imageUri == imageUri)&&(identical(other.aiResponseEnabled, aiResponseEnabled) || other.aiResponseEnabled == aiResponseEnabled));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,content,moodName,imageUri,aiResponseEnabled);

@override
String toString() {
  return 'AddJournalRequest(content: $content, moodName: $moodName, imageUri: $imageUri, aiResponseEnabled: $aiResponseEnabled)';
}
...
@useResult
$Res call({
 String? content, String moodName, String? imageUri, bool aiResponseEnabled
});
...
/// Create a copy of AddJournalRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? content = freezed,Object? moodName = null,Object? imageUri = freezed,Object? aiResponseEnabled = null,}) {
...
class _AddJournalRequest implements AddJournalRequest {
  const _AddJournalRequest({required this.content, required this.moodName, required this.imageUri, required this.aiResponseEnabled});
...
/// Create a copy of AddJournalRequest
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? content = freezed,Object? moodName = null,Object? imageUri = freezed,Object? aiResponseEnabled = null,}) {
