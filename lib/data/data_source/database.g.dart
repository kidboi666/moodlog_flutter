...
class $$AppStatesTableFilterComposer
    extends Composer<_$MoodLogDatabase, $AppStatesTable> {
...
class $$AppStatesTableTableManager
    extends
        RootTableManager<
          ...
          (
            AppState,
            BaseReferences<_$MoodLogDatabase, $AppStatesTable, AppState>,
          ),
          AppState,
          PrefetchHooks Function()
        > {
  $$AppStatesTableTableManager(_$MoodLogDatabase db, $AppStatesTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
...
typedef $$AppStatesTableProcessedTableManager =
    ProcessedTableManager<
      ...
      $$AppStatesTableCreateCompanionBuilder,
      $$AppStatesTableUpdateCompanionBuilder,
      (AppState, BaseReferences<_$MoodLogDatabase, $AppStatesTable, AppState>),
      AppState,
      PrefetchHooks Function()
    >;
