...
class _UpdateJournalRequest extends UpdateJournalRequest {
  const _UpdateJournalRequest({required this.id, this.content, final  List<String>? imageUri, this.aiResponse, this.latitude, this.longitude, this.address}): _imageUri = imageUri,super._();
