...
mixin _$UserMetadata {
  ...
  $UserMetadataCopyWith<UserMetadata> get copyWith =>
      _$UserMetadataCopyWithImpl<UserMetadata>(
          this as UserMetadata, _$identity);


  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is UserMetadata &&
...
abstract mixin class $UserMetadataCopyWith<$Res> {
  factory $UserMetadataCopyWith(UserMetadata value,
      $Res Function(UserMetadata) _then) = _$UserMetadataCopyWithImpl;
...
class _$UserMetadataCopyWithImpl<$Res>
  ...
  @override
  $Res call(
      {Object? creationTime = freezed, Object? lastSignInTime = freezed,}) {
...
extension UserMetadataPatterns on UserMetadata {
  ...
  TResult Function( _UserMetadata value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _UserMetadata implements UserMetadata {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$UserMetadataCopyWith<_UserMetadata> get copyWith =>
      __$UserMetadataCopyWithImpl<_UserMetadata>(this, _$identity);


  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _UserMetadata &&
            (identical(other.creationTime, creationTime) ||
                other.creationTime == creationTime) &&
            (identical(other.lastSignInTime, lastSignInTime) ||
                other.lastSignInTime == lastSignInTime));
...
/// @nodoc
abstract mixin class _$UserMetadataCopyWith<$Res>
    implements $UserMetadataCopyWith<$Res> {
  factory _$UserMetadataCopyWith(_UserMetadata value,
      $Res Function(_UserMetadata) _then) = __$UserMetadataCopyWithImpl;
