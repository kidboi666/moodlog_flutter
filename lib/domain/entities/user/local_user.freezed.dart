...
mixin _$LocalUser {
  ...
  $LocalUserCopyWith<LocalUser> get copyWith =>
      _$LocalUserCopyWithImpl<LocalUser>(this as LocalUser, _$identity);


  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is LocalUser &&
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, userId, nickname, profileImagePath, createdAt);
...
abstract mixin class $LocalUserCopyWith<$Res> {
  factory $LocalUserCopyWith(LocalUser value,
      $Res Function(LocalUser) _then) = _$LocalUserCopyWithImpl;
...
class _$LocalUserCopyWithImpl<$Res>
  ...
  @override
  $Res call(
      {Object? userId = null, Object? nickname = null, Object? profileImagePath = freezed, Object? createdAt = null,}) {
...
extension LocalUserPatterns on LocalUser {
  ...
  TResult Function( _LocalUser value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _LocalUser implements LocalUser {
  const _LocalUser(
      {required this.userId, required this.nickname, this.profileImagePath, required this.createdAt});
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _LocalUser &&
            (identical(other.userId, userId) || other.userId == userId) &&
            (identical(other.nickname, nickname) ||
                other.nickname == nickname) &&
            (identical(other.profileImagePath, profileImagePath) ||
...
/// @nodoc
abstract mixin class _$LocalUserCopyWith<$Res>
    implements $LocalUserCopyWith<$Res> {
  factory _$LocalUserCopyWith(_LocalUser value,
      $Res Function(_LocalUser) _then) = __$LocalUserCopyWithImpl;
