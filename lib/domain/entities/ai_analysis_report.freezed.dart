...
mixin _$AiAnalysisReport {
 ...
 String get summary; List<String> get positiveKeywords; List<String> get negativeKeywords; String get emotionalPattern; String get activityCorrelation;
...
@useResult
$Res call({
 String summary, List<String> positiveKeywords, List<String> negativeKeywords, String emotionalPattern, String activityCorrelation
});
...
/// Create a copy of AiAnalysisReport
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? summary = null,Object? positiveKeywords = null,Object? negativeKeywords = null,Object? emotionalPattern = null,Object? activityCorrelation = null,}) {
...
as String,activityCorrelation: null == activityCorrelation ? _self.activityCorrelation : activityCorrelation // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String summary,  List<String> positiveKeywords,  List<String> negativeKeywords,  String emotionalPattern,  String activityCorrelation)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AiAnalysisReport() when $default != null:
return $default(_that.summary,_that.positiveKeywords,_that.negativeKeywords,_that.emotionalPattern,_that.activityCorrelation);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String summary,  List<String> positiveKeywords,  List<String> negativeKeywords,  String emotionalPattern,  String activityCorrelation)  $default,) {final _that = this;
switch (_that) {
case _AiAnalysisReport():
return $default(_that.summary,_that.positiveKeywords,_that.negativeKeywords,_that.emotionalPattern,_that.activityCorrelation);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String summary,  List<String> positiveKeywords,  List<String> negativeKeywords,  String emotionalPattern,  String activityCorrelation)?  $default,) {final _that = this;
switch (_that) {
case _AiAnalysisReport() when $default != null:
return $default(_that.summary,_that.positiveKeywords,_that.negativeKeywords,_that.emotionalPattern,_that.activityCorrelation);case _:
  return null;
...
class _AiAnalysisReport implements AiAnalysisReport {
  const _AiAnalysisReport({required this.summary, required final  List<String> positiveKeywords, required final  List<String> negativeKeywords, required this.emotionalPattern, required this.activityCorrelation}): _positiveKeywords = positiveKeywords,_negativeKeywords = negativeKeywords;
...
@override final  String activityCorrelation;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,summary,const DeepCollectionEquality().hash(_positiveKeywords),const DeepCollectionEquality().hash(_negativeKeywords),emotionalPattern,activityCorrelation);
...
/// Create a copy of AiAnalysisReport
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? summary = null,Object? positiveKeywords = null,Object? negativeKeywords = null,Object? emotionalPattern = null,Object? activityCorrelation = null,}) {
