...
mixin _$ScreenView {
 ...
 String get screenName; String? get screenClass;
/// Create a copy of ScreenView
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$ScreenViewCopyWith<ScreenView> get copyWith => _$ScreenViewCopyWithImpl<ScreenView>(this as ScreenView, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ScreenView&&(identical(other.screenName, screenName) || other.screenName == screenName)&&(identical(other.screenClass, screenClass) || other.screenClass == screenClass));
}
...
abstract mixin class $ScreenViewCopyWith<$Res>  {
  factory $ScreenViewCopyWith(ScreenView value, $Res Function(ScreenView) _then) = _$ScreenViewCopyWithImpl;
@useResult
$Res call({
...
/// Create a copy of ScreenView
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? screenName = null,Object? screenClass = freezed,}) {
  return _then(_self.copyWith(
screenName: null == screenName ? _self.screenName : screenName // ignore: cast_nullable_to_non_nullable
as String,screenClass: freezed == screenClass ? _self.screenClass : screenClass // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ScreenView value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@pragma('vm:prefer-inline')
_$ScreenViewCopyWith<_ScreenView> get copyWith => __$ScreenViewCopyWithImpl<_ScreenView>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ScreenView&&(identical(other.screenName, screenName) || other.screenName == screenName)&&(identical(other.screenClass, screenClass) || other.screenClass == screenClass));
}
...
/// @nodoc
abstract mixin class _$ScreenViewCopyWith<$Res> implements $ScreenViewCopyWith<$Res> {
  factory _$ScreenViewCopyWith(_ScreenView value, $Res Function(_ScreenView) _then) = __$ScreenViewCopyWithImpl;
@override @useResult
$Res call({
 String screenName, String? screenClass
});
...
/// Create a copy of ScreenView
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? screenName = null,Object? screenClass = freezed,}) {
