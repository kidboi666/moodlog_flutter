...
$AnalyticsObserverCopyWith<AnalyticsObserver> get copyWith => _$AnalyticsObserverCopyWithImpl<AnalyticsObserver>(this as AnalyticsObserver, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AnalyticsObserver&&(identical(other.name, name) || other.name == name)&&const DeepCollectionEquality().equals(other.properties, properties));
}
...
abstract mixin class $AnalyticsObserverCopyWith<$Res>  {
  factory $AnalyticsObserverCopyWith(AnalyticsObserver value, $Res Function(AnalyticsObserver) _then) = _$AnalyticsObserverCopyWithImpl;
@useResult
$Res call({
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _AnalyticsObserver value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
class _AnalyticsObserver implements AnalyticsObserver {
  const _AnalyticsObserver({required this.name, required final  Map<String, dynamic> properties}): _properties = properties;
...
@pragma('vm:prefer-inline')
_$AnalyticsObserverCopyWith<_AnalyticsObserver> get copyWith => __$AnalyticsObserverCopyWithImpl<_AnalyticsObserver>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AnalyticsObserver&&(identical(other.name, name) || other.name == name)&&const DeepCollectionEquality().equals(other._properties, _properties));
}
...
/// @nodoc
abstract mixin class _$AnalyticsObserverCopyWith<$Res> implements $AnalyticsObserverCopyWith<$Res> {
  factory _$AnalyticsObserverCopyWith(_AnalyticsObserver value, $Res Function(_AnalyticsObserver) _then) = __$AnalyticsObserverCopyWithImpl;
@override @useResult
$Res call({
 String name, Map<String, dynamic> properties
});
