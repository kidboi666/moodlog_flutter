...
mixin _$MoodAnalytics {
  ...
  $MoodAnalyticsCopyWith<MoodAnalytics> get copyWith =>
      _$MoodAnalyticsCopyWithImpl<MoodAnalytics>(
          this as MoodAnalytics, _$identity);


  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is MoodAnalytics &&
            ...
            (identical(other.hasTag, hasTag) || other.hasTag == hasTag));
  }


  @override
  int get hashCode =>
      Object.hash(runtimeType, moodType, entryType, hasImage, hasTag);
...
abstract mixin class $MoodAnalyticsCopyWith<$Res> {
  factory $MoodAnalyticsCopyWith(MoodAnalytics value,
      $Res Function(MoodAnalytics) _then) = _$MoodAnalyticsCopyWithImpl;
...
class _$MoodAnalyticsCopyWithImpl<$Res>
  ...
  @override
  $Res call(
      {Object? moodType = null, Object? entryType = null, Object? hasImage = null, Object? hasTag = null,}) {
    return _then(_self.copyWith(
      ...
      hasTag: null == hasTag
          ? _self.hasTag
          : hasTag // ignore: cast_nullable_to_non_nullable
      as bool,
    ));
  }
...
extension MoodAnalyticsPatterns on MoodAnalytics {
  ...
  TResult Function( _MoodAnalytics value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _MoodAnalytics extends MoodAnalytics {
  const _MoodAnalytics(
      {required this.moodType, required this.entryType, this.hasImage = false, this.hasTag = false})
      : super._();
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$MoodAnalyticsCopyWith<_MoodAnalytics> get copyWith =>
      __$MoodAnalyticsCopyWithImpl<_MoodAnalytics>(this, _$identity);


  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _MoodAnalytics &&
            (identical(other.moodType, moodType) ||
                other.moodType == moodType) &&
            (identical(other.entryType, entryType) ||
                other.entryType == entryType) &&
...
/// @nodoc
abstract mixin class _$MoodAnalyticsCopyWith<$Res>
    implements $MoodAnalyticsCopyWith<$Res> {
  factory _$MoodAnalyticsCopyWith(_MoodAnalytics value,
      $Res Function(_MoodAnalytics) _then) = __$MoodAnalyticsCopyWithImpl;
