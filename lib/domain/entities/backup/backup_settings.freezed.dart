...
mixin _$BackupSettings {
 ...
 bool get hasNotificationEnabled; bool get hasAutoSyncEnabled; String get themeMode; String get colorTheme; String get languageCode; String get aiPersonality; String get fontType; String get textAlign; bool get isOnboardingComplete; bool get isAppLockEnabled; String get lockType; bool get isProUser;
...
@override
String toString() {
  return 'BackupSettings(hasNotificationEnabled: $hasNotificationEnabled, hasAutoSyncEnabled: $hasAutoSyncEnabled, themeMode: $themeMode, colorTheme: $colorTheme, languageCode: $languageCode, aiPersonality: $aiPersonality, fontType: $fontType, textAlign: $textAlign, isOnboardingComplete: $isOnboardingComplete, isAppLockEnabled: $isAppLockEnabled, lockType: $lockType, isProUser: $isProUser)';
}
...
@useResult
$Res call({
 bool hasNotificationEnabled, bool hasAutoSyncEnabled, String themeMode, String colorTheme, String languageCode, String aiPersonality, String fontType, String textAlign, bool isOnboardingComplete, bool isAppLockEnabled, String lockType, bool isProUser
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool hasNotificationEnabled,  bool hasAutoSyncEnabled,  String themeMode,  String colorTheme,  String languageCode,  String aiPersonality,  String fontType,  String textAlign,  bool isOnboardingComplete,  bool isAppLockEnabled,  String lockType,  bool isProUser)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BackupSettings() when $default != null:
...
class _BackupSettings implements BackupSettings {
  const _BackupSettings({required this.hasNotificationEnabled, required this.hasAutoSyncEnabled, required this.themeMode, required this.colorTheme, required this.languageCode, required this.aiPersonality, required this.fontType, required this.textAlign, required this.isOnboardingComplete, required this.isAppLockEnabled, required this.lockType, required this.isProUser});
