...
mixin _$Settings {
 ...
 bool get hasNotificationEnabled; bool get hasAutoSyncEnabled; ThemeMode get themeMode; ColorTheme get colorTheme; LanguageCode get languageCode; AiPersonality get aiPersonality; FontFamily get fontFamily; SimpleTextAlign get textAlign; bool get isOnboardingComplete; bool get isAppLockEnabled; LockType get lockType; bool get isProUser;
...
@override
int get hashCode => Object.hash(runtimeType,hasNotificationEnabled,hasAutoSyncEnabled,themeMode,colorTheme,languageCode,aiPersonality,fontFamily,textAlign,isOnboardingComplete,isAppLockEnabled,lockType,isProUser);
...
@useResult
$Res call({
 bool hasNotificationEnabled, bool hasAutoSyncEnabled, ThemeMode themeMode, ColorTheme colorTheme, LanguageCode languageCode, AiPersonality aiPersonality, FontFamily fontFamily, SimpleTextAlign textAlign, bool isOnboardingComplete, bool isAppLockEnabled, LockType lockType, bool isProUser
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool hasNotificationEnabled,  bool hasAutoSyncEnabled,  ThemeMode themeMode,  ColorTheme colorTheme,  LanguageCode languageCode,  AiPersonality aiPersonality,  FontFamily fontFamily,  SimpleTextAlign textAlign,  bool isOnboardingComplete,  bool isAppLockEnabled,  LockType lockType,  bool isProUser)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Settings() when $default != null:
return $default(_that.hasNotificationEnabled,_that.hasAutoSyncEnabled,_that.themeMode,_that.colorTheme,_that.languageCode,_that.aiPersonality,_that.fontFamily,_that.textAlign,_that.isOnboardingComplete,_that.isAppLockEnabled,_that.lockType,_that.isProUser);case _:
  return orElse();
...
class _Settings extends Settings {
  const _Settings({this.hasNotificationEnabled = false, this.hasAutoSyncEnabled = false, this.themeMode = ThemeMode.system, this.colorTheme = ColorTheme.blue, this.languageCode = LanguageCode.ko, this.aiPersonality = AiPersonality.balanced, this.fontFamily = FontFamily.restart, this.textAlign = SimpleTextAlign.left, this.isOnboardingComplete = false, this.isAppLockEnabled = false, this.lockType = LockType.none, this.isProUser = false}): super._();
