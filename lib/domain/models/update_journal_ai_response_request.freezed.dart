...
mixin _$UpdateJournalAiResponseRequest {
  ...
  $UpdateJournalAiResponseRequestCopyWith<
      UpdateJournalAiResponseRequest> get copyWith =>
      _$UpdateJournalAiResponseRequestCopyWithImpl<
          UpdateJournalAiResponseRequest>(
          this as UpdateJournalAiResponseRequest, _$identity);


  @override
  bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType &&
        other is UpdateJournalAiResponseRequest &&
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, aiResponseEnabled, aiResponse);
...
abstract mixin class $UpdateJournalAiResponseRequestCopyWith<$Res> {
  factory $UpdateJournalAiResponseRequestCopyWith(
      UpdateJournalAiResponseRequest value,
      $Res Function(UpdateJournalAiResponseRequest) _then) = _$UpdateJournalAiResponseRequestCopyWithImpl;
...
class _$UpdateJournalAiResponseRequestCopyWithImpl<$Res>
  ...
  @override
  $Res call(
      {Object? id = null, Object? aiResponseEnabled = null, Object? aiResponse = freezed,}) {
...
extension UpdateJournalAiResponseRequestPatterns on UpdateJournalAiResponseRequest {
  ...
  TResult Function( _UpdateJournalAiResponseRequest value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _UpdateJournalAiResponseRequest extends UpdateJournalAiResponseRequest {
  const _UpdateJournalAiResponseRequest(
      {required this.id, required this.aiResponseEnabled, required this.aiResponse})
      : super._();
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$UpdateJournalAiResponseRequestCopyWith<
      _UpdateJournalAiResponseRequest> get copyWith =>
      __$UpdateJournalAiResponseRequestCopyWithImpl<
          _UpdateJournalAiResponseRequest>(this, _$identity);


  @override
  bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType &&
        other is _UpdateJournalAiResponseRequest &&
        (identical(other.id, id) || other.id == id) &&
        (identical(other.aiResponseEnabled, aiResponseEnabled) ||
            other.aiResponseEnabled == aiResponseEnabled) &&
        (identical(other.aiResponse, aiResponse) ||
...
/// @nodoc
abstract mixin class _$UpdateJournalAiResponseRequestCopyWith<$Res>
    implements $UpdateJournalAiResponseRequestCopyWith<$Res> {
  factory _$UpdateJournalAiResponseRequestCopyWith(
      _UpdateJournalAiResponseRequest value,
      $Res Function(_UpdateJournalAiResponseRequest) _then) = __$UpdateJournalAiResponseRequestCopyWithImpl;
