...
mixin _$UpdateJournalRequest {
  ...
  $UpdateJournalRequestCopyWith<UpdateJournalRequest> get copyWith =>
      _$UpdateJournalRequestCopyWithImpl<UpdateJournalRequest>(
          this as UpdateJournalRequest, _$identity);


  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is UpdateJournalRequest &&
...
abstract mixin class $UpdateJournalRequestCopyWith<$Res> {
  factory $UpdateJournalRequestCopyWith(UpdateJournalRequest value,
      $Res Function(UpdateJournalRequest) _then) = _$UpdateJournalRequestCopyWithImpl;

  @useResult
  $Res call({
    int id, MoodType moodType, String? content, List<
        String>? imageUri, bool aiResponseEnabled, double? latitude, double? longitude, String? address, List<
        String>? tagNames
  });
...
class _$UpdateJournalRequestCopyWithImpl<$Res>
  ...
  @override
  $Res call(
      {Object? id = null, Object? moodType = null, Object? content = freezed, Object? imageUri = freezed, Object? aiResponseEnabled = null, Object? latitude = freezed, Object? longitude = freezed, Object? address = freezed, Object? tagNames = freezed,}) {
...
extension UpdateJournalRequestPatterns on UpdateJournalRequest {
  ...
  TResult Function( _UpdateJournalRequest value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _UpdateJournalRequest extends UpdateJournalRequest {
  const _UpdateJournalRequest(
      {required this.id, required this.moodType, this.content, final List<
          String>? imageUri, required this.aiResponseEnabled, this.latitude, this.longitude, this.address, final List<
          String>? tagNames})
      : _imageUri = imageUri,
        _tagNames = tagNames,
        super._();
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$UpdateJournalRequestCopyWith<_UpdateJournalRequest> get copyWith =>
      __$UpdateJournalRequestCopyWithImpl<_UpdateJournalRequest>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _UpdateJournalRequest &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.moodType, moodType) ||
                other.moodType == moodType) &&
            (identical(other.content, content) || other.content == content) &&
...
/// @nodoc
abstract mixin class _$UpdateJournalRequestCopyWith<$Res>
    implements $UpdateJournalRequestCopyWith<$Res> {
  factory _$UpdateJournalRequestCopyWith(_UpdateJournalRequest value,
      $Res Function(_UpdateJournalRequest) _then) = __$UpdateJournalRequestCopyWithImpl;
